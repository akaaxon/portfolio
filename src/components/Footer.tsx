...
export default function FooterSection() {
  ...
  href="/contact"
  className="
    relative mt-5 w-62 h-62 md:w-64 md:h-64 rounded-full border-4 border-black bg-black
...
>
  <span className="relative z-10 italic">➢ Contact me</span>
        ...
        <div
          ref={textRef}
          className="text-black text-5xl md:text-6xl italic lg:text-8xl font-extrabold text-center md:text-right leading-tight max-w-xl"
        >
